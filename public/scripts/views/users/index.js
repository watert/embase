...
define(["views/_base/view", "tmpls/base"], function(BaseView, baseTmpl) {
  ...
  navbar = baseTmpl.navbar, toolbar = baseTmpl.toolbar, templer = baseTmpl.templer;
  return UserIndexView = (function(superClass) {
    ...
    UserIndexView.prototype.template = baseTmpl.extend({
      detail: "",
