...
/***/ function(module, exports, __webpack_require__) {
	...
	var tmpls = __webpack_require__(5);

	var AuthView = (function (_Backbone$View) {
	    _inherits(AuthView, _Backbone$View);

	    function AuthView(args) {
	        _classCallCheck(this, AuthView);

	        _get(Object.getPrototypeOf(AuthView.prototype), 'constructor', this).apply(this, args);
	    }
	    ...
	    _createClass(AuthView, [{
	        ...
	        value: function render() {
	            var name = arguments.length <= 0 || arguments[0] === undefined ? "login" : arguments[0];
	            var data = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

	            var html = _.template(tmpls[name])(data);
	            this.$el.html(html);
	        }
	    }, {
	        key: 'className',
